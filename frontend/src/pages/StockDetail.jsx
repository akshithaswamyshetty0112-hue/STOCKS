...
return ( <div className="grid gap-6"> <div className="rounded-lg border border-slate-200 bg-white p-6"> <div className="flex items-end justify-between"> <div> <p className="text-sm font-semibold text-slate-500">
{stock.symbol} </p> <h1 className="text-3xl font-bold text-slate-900">
{stock.company} </h1> </div>
